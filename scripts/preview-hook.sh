...
echo -e "${BLUE}Phase 9.1 Update: Now includes File Attachments & Large Upload${NC}"
echo -e "${BLUE}════════════════════════════════════════════════════════════${NC}"
echo ""
...
echo "Running all 11 E2E test scripts (Phases 2-7 + Sprints 8.1-8.4 + Sprint 9.1)..."
...
echo -e "${YELLOW}[1/11]${NC} Running Phase 2 E2E tests (Email)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[2/11]${NC} Running Phase 3 E2E tests (Calendar)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[3/11]${NC} Running Phase 4 E2E tests (OneDrive)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[4/11]${NC} Running Phase 5 E2E tests (Teams & SharePoint)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[5/11]${NC} Running Phase 6 E2E tests (Contacts & To Do)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[6/11]${NC} Running Phase 7 E2E tests (User Tools)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[7/11]${NC} Running Sprint 8.1 E2E tests (Search & Query)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[8/11]${NC} Running Sprint 8.2 E2E tests (Batch Operations)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[9/11]${NC} Running Sprint 8.3 E2E tests (Advanced Calendar)..."
echo "─────────────────────────────────────────────────────────"
...
echo -e "${YELLOW}[10/11]${NC} Running Sprint 8.4 E2E tests (Teams Advanced)..."
echo "─────────────────────────────────────────────────────────"
...
# Test 11: Sprint 9.1 — File Attachments & Large Upload
echo -e "${YELLOW}[11/11]${NC} Running Sprint 9.1 E2E tests (File Attachments)..."
echo "─────────────────────────────────────────────────────────"

pnpm tsx "$SCRIPT_DIR/test-sprint-9-1-e2e.ts" 2>&1 || true
if [ ${PIPESTATUS[0]} -eq 0 ]; then
    echo -e "${GREEN}✓${NC} Sprint 9.1 passed"
    TEST_RESULTS+=("✓")
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}✗${NC} Sprint 9.1 failed or skipped"
    TEST_RESULTS+=("✗")
    FAILED=$((FAILED + 1))
fi
TEST_NAMES+=("Sprint 9.1: File Attachments")
echo ""
