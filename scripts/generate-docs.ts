...
function generateToolsMd(tools: ToolInfo[]): string {
  ...
  if (tools.length === 0) {
    ...
    lines.push("");
    lines.push("_Noch keine Tools implementiert. Wird ab Phase 2 befüllt._");
    lines.push("");
    lines.push("## Tool-Format");
    lines.push("");
    lines.push("Jedes Tool hat:");
    lines.push("- **Name:** snake_case Bezeichner");
    lines.push("- **Description:** Für LLM-Auswahl optimierte Beschreibung");
    ...
    lines.push("");
    lines.push("Siehe Project_Description.md Abschnitte 2.3 und 8 für die vollständige Liste.");
  } else {
    lines.push("## Implementierte Tools");
    lines.push("");
...
function generatePermissionsMd(tools: ToolInfo[]): string {
  ...
  lines.push("");
  lines.push("| Scope | Begründung | Tools |");
  lines.push("|---|---|---|");
