...
export const DEFAULT_SELECT: Record<string, string[]> = {
  ...
  team: ["id", "displayName", "description", "isArchived", "webUrl"],
  channel: ["id", "displayName", "description", "webUrl", "membershipType"],
  chat: ["id", "chatType", "topic", "lastUpdatedDateTime", "webUrl"],
  site: ["id", "displayName", "description", "webUrl"],
  siteDetail: [
    "id",
    "displayName",
    "description",
  ...
  siteDrive: ["id", "name", "driveType", "webUrl"],
  ...
  todoList: ["id", "displayName", "wellknownListName", "isOwner", "isShared"],
  mailFolder: [
    "id",
    "displayName",
    "parentFolderId",
