...
describe("share_calendar", () => {
  ...
  describe("Tool handler", () => {
    it("should register and execute share_calendar tool", async () => {
      const { McpServer } = await import("@modelcontextprotocol/sdk/server/mcp.js");
      const { registerCalendarSharingTools } = await import("../src/tools/calendar-sharing.js");
      ...
      registerCalendarSharingTools(testServer, graphClient, testConfig);
    ...
    it("should register without throwing", async () => {
      ...
      expect(() => registerCalendarSharingTools(testServer, graphClient, testConfig)).not.toThrow();
    });
  });
});
